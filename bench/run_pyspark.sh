...
for c in spark-master spark-worker-1 spark-jupyter; do
...
bash bench/collect_stats.sh "results/${ENGINE}_stats.csv" kafka spark-master spark-worker-1 spark-jupyter &
STATS_PID=$!
